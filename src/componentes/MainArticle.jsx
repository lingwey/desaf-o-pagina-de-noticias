   ...
   <section className="mb-12">
      ...
      <div className="md:flex">
          <div className="flex-1 py-6">
            <h2 className="text-[40px] font-bold md:text-[58px] leading-none">The Bright Future of Web 3.0?</h2>
          </div>
          <div className="flex-1 pt-9 px-4">
            <p className="text-[13px] mb-10 md:text-[15px] ">We dive into the next evolution of the web that claims to put the power of the platforms back into the hands of the people. But is it really fulfilling its promise?</p>
